...
function inrel() {
    ...
    const b = document.getElementById("fbut2alt");
     ...
     c.innerHTML = "";
     c.innerHTML = "Em rất giống với con dâu tương lai của ba mẹ Anh =))";
     y.style.display="none";
     x.style.display="inline";
     document.getElementById("audio3").play();
     document.getElementById("alert2").innerHTML = "";
     document.getElementById("des").innerHTML = "Em biết không Anh yêu em nhiều lắm, Em đồng ý YÊU ANH hơn nhé 😳";
     return false;
...
function trollalt() {
    ...
    alert("Sao Em không muốn ? Em sẽ rất bất ngờ đấy !");
    return false;
}
